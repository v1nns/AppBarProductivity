...
#pragma warning(disable : 4373)	// C++ exception specification ignored...
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
// 
...
{	virtual bool IsStraightOrder(TabCtrl * /*pCtrl*/) { return true; }	// true - paint tabs left to right, false - reverse order.
	...
	virtual void DrawTab(TabCtrl * /*pCtrl*/, CDC * /*pDC*/, HTAB /*hTab*/, CRgn * /*pRgn*/, bool const /*isCurrentTab*/) {}
	...
	virtual void DrawButtonAddTab(TabCtrl * /*pCtrl*/, CDC * /*pDC*/, CRect const * /*pRect*/, bool /*bHover*/, bool /*bPushed*/, bool /*bPartialView*/) {}
...
{	virtual int GetBorderWidth(TabCtrl *pCtrl, ITabCtrlRecalc *base) = 0;
	...
	virtual CRect GetAddTabButtonHorzMargin(TabCtrl *pCtrl, ITabCtrlRecalc *base) = 0;	// uses only CRect::left and CRect::right.
};
// 
...
{	virtual bool CanShowCloseButton(TabCtrl * /*pCtrl*/) { return true; }
	...
	virtual bool CanShowAddTabButton(TabCtrl * /*pCtrl*/) { return true; }
};
// 
...
{	virtual void OnTabPreCreate(TabCtrl * /*pCtrl*/, HWND /*hWnd*/, TCHAR const * /*text*/, int /*image*/) {}
	...
	virtual void OnAddTabButtonClicked(TabCtrl * /*pCtrl*/, CRect const * /*pRect*/, CPoint /*ptScr*/) {}	// ptScr - in screen space.
...
public:
	...
	void SetAddTabButToolTipText(TCHAR const *text) throw(std::bad_alloc);
	CString GetAddTabButToolTipText() const;
		// 
	...
	void ShowAddTabButton(bool show);
	bool IsShowAddTabButton() const;
		// 
...
public:	// functions of ITabCtrlRecalc interface, return information from current recalc manager.
	...
	CRect GetAddTabButtonHorzMargin();
...
private:
	...
	CString m_sToolTip;
	CString m_sToolTipButClose, m_sToolTipButMenu, m_sToolTipButLeftScroll,m_sToolTipButRightScroll,m_sToolTipButAddTab;
		// 
	bool m_bShowBorder;
	...
	TabCtrlNotify *m_pNotifyManager;
		// 
	const HTAB m_hButClose, m_hButMenu, m_hButLeftScroll, m_hButRightScroll, m_hButAddTab;
...
private:
	...
	bool m_bPartialView, m_bScrollLeftAllow,m_bScrollRightAllow, m_bAddTab;
		// 
	bool m_bTabDrag;
	...
	CRect m_rcCloseButton, m_rcMenuButton, m_rcScrollLeft,m_rcScrollRight, m_rcAddTab;
		// 
...
private:
	...
	{		// ITabCtrlRecalc.
		...
		virtual CRect GetAddTabButtonHorzMargin(TabCtrl * pCtrl, ITabCtrlRecalc * base);
			// 
			// ITabCtrlBehavior.
...
protected:
	...
	virtual void DrawBorder(TabCtrl *pCtrl, CDC *pDC, CRect const *pRect);
	virtual void DrawCtrlAreaBack(TabCtrl *pCtrl, CDC *pDC, CRect const *pRect);
	virtual void DrawTab(TabCtrl *pCtrl, CDC *pDC, HTAB hTab, CRgn *pRgn, bool isCurrentTab = false);
	virtual void DrawButtonClose(TabCtrl *pCtrl, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed);
	virtual void DrawButtonMenu(TabCtrl *pCtrl, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed, bool bPartialView);
	virtual void DrawButtonScrollLeft(TabCtrl *pCtrl, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed, bool bPartialView);
	virtual void DrawButtonScrollRight(TabCtrl *pCtrl, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed, bool bPartialView);
