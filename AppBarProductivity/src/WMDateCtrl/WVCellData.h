...
public:
	...
	void DrawItems(CDC *pDC, BOOL bMonView = FALSE);
	...
	BOOL GetHighlightEntireArea();
	void SetHighlightEntireArea(BOOL bOK);
...
private:
	...
	void DrawDoNotFit(CDC *pDC, CRect *pRect);

	long nItemCount;
	BOOL bHighlight, bHighlightEntireArea, bMilTime, bDNFClicked, bMonthView;
	int nCellID;
