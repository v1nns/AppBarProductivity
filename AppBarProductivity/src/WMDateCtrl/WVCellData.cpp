...
CWVCellData::CWVCellData()
{
	...
	bMonthView = bHighlight = bHighlightEntireArea = FALSE;
...
void CWVCellData::SetHighlightEntireArea(BOOL bOK)
{
	bHighlightEntireArea = bOK;
}

BOOL CWVCellData::GetHighlightEntireArea()
{
	return bHighlightEntireArea;
}
...
void CWVCellData::DrawItems(CDC *pDC, BOOL bMonView/*= FALSE*/)
{
	CRect rItem;
...
void CWVCellData::DrawDoNotFit(CDC *pDC, CRect *pRect)
{
