...
// @cmember empty Constructor
	CScintillaWnd();
	CScintillaWnd(const CScintillaWnd& other);
// @cmember destructor
...
//#################################################
// Shortkeys
// @cmember change selected text bold
   virtual void OnTextBold();
...
// @cmember search flags
   int  m_nSearchflags;
// @cmember handle to accelerator table to short keys
   HACCEL m_hAccel;
};
#define STR_SCINTILLAWND _T("Scintilla")
#define STR_LEXERDLL     _T("lib\\scilexer.dll")
