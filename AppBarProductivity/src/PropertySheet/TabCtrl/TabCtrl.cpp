...
TabCtrl::TabCtrl() :
	...
	m_hButLeftScroll((HTAB)3), m_hButRightScroll((HTAB)4), m_hButAddTab((HTAB)5)
{
	m_hCurTab = NULL;
	m_hHoverArea = NULL;
	m_hPushedArea = NULL;
	m_iTabsOffset = 0;
	m_bPartialView = m_bScrollLeftAllow = m_bScrollRightAllow = m_bAddTab = false;
	m_bTabDrag = false;
...
{	CFont *font = CFont::FromHandle((HFONT)::GetStockObject(DEFAULT_GUI_FONT));
	...
	{	CRect rc(0,0,0,0);
		...
		{	if(m_sToolTipButClose.IsEmpty()!=0) m_sToolTipButClose = _T("Close");
			...
			if(m_sToolTipButAddTab.IsEmpty() != 0) m_sToolTipButAddTab = _T("New tab");
		}
		catch(CMemoryException *p)
		{	p->Delete();
			return false;
...
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrl::SetAddTabButToolTipText(TCHAR const *text) throw(std::bad_alloc)
{	CSTRING_BAD_ALLOC(m_sToolTipButAddTab = text);
}
// 
CString TabCtrl::GetAddTabButToolTipText() const
{	return m_sToolTipButAddTab;
}
...
{	GetClientRect(&m_rcWindows);
	...
	{	m_rcCtrlArea = m_rcWindows;
		...
		bool bShowAddTabButton = (m_bShowAddTabButton==true && 
			m_pSysImageListRef != NULL && m_pSysImageListRef->m_hImageList != NULL && 
			m_pAbilityManager->CanShowAddTabButton(this) == true);
			// 
		...
		{	m_rcScrollLeft.SetRectEmpty();
			...
			// 
		if (bShowAddTabButton == true)
		{
			CRect rcAddTabHorzMargin = GetAddTabButtonHorzMargin();

			m_rcAddTab = m_rcTabs;
			
			m_rcAddTab.left = m_rcAddTab.right - m_szSysImage.cx;
			m_rcAddTab.right -= rcAddTabHorzMargin.right;
			
			m_rcTabs.right = m_rcAddTab.left - rcAddTabHorzMargin.left;
			// 
			m_rcAddTab.top = iSysImagePosY;
			m_rcAddTab.bottom = m_rcAddTab.top + m_szSysImage.cy;
		}
		else
			m_rcAddTab.SetRectEmpty();
			// 
...
{	m_sToolTip = _T("");
	...
	if(m_hHoverArea!=NULL)
		...
		else if (m_hHoverArea == m_hButAddTab) m_sToolTip = m_sToolTipButAddTab;
		else
	...
	{	m_pDrawManager->DrawCtrlAreaBack(this,&virtwnd,&m_rcCtrlArea);
		...
		{	for(m_i_vtrtabs i=m_vtrtabs.begin(), e=m_vtrtabs.end(); i!=e; ++i)
				if(*i!=m_hCurTab && IsTabVisible(*i,NULL)==true)
					m_pDrawManager->DrawTab(this,&virtwnd,*i,&rgn, false);
		}
		else	// right to left.
		...
		if(m_hCurTab!=NULL)
			...
			{	CFont *pOldFont = (CFont *)virtwnd.SelectObject( GetFontSelect() );
				m_pDrawManager->DrawTab(this,&virtwnd,m_hCurTab,&rgn,true);
				virtwnd.SelectObject(pOldFont);
			}
			else
				m_pDrawManager->DrawTab(this,&virtwnd,m_hCurTab,&rgn,false);
			// 
		virtwnd.SelectClipRgn(NULL,RGN_COPY);
		virtwnd.SelectObject(pOldFont);
			// 

		if (m_rcAddTab.IsRectEmpty() == 0)
		{
			bool bHover = m_hHoverArea == m_hButAddTab && (m_hPushedArea == NULL || m_hPushedArea == m_hButAddTab);
			m_pDrawManager->DrawButtonAddTab(this, &virtwnd, &m_rcAddTab, bHover, m_hPushedArea == m_hButAddTab, m_bAddTab);
		}
...
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrl::ShowAddTabButton(bool show)
{
	m_bShowAddTabButton = show;
}
// 
bool TabCtrl::IsShowAddTabButton() const
{
	return m_bShowAddTabButton;
}
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
// 
...
//
CRect TabCtrl::Service::GetAddTabButtonHorzMargin(TabCtrl * /*pCtrl*/, ITabCtrlRecalc * /*base*/)
{	return CRect(2,0,0,0);
}
/////////////////////////////////////////////////////////////////////////////
// 
...
//
CRect TabCtrl::GetAddTabButtonHorzMargin()
{	return m_pRecalcManager->GetAddTabButtonHorzMargin(this, &m_Service);
}
/////////////////////////////////////////////////////////////////////////////
// 
...
RECT TabCtrl::GetAddTabRect() const
{	return m_rcAddTab;
}
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
...
{	HTAB hHoverAreaOld = m_hHoverArea;
	...
	if(m_hCurTab!=NULL)
		...
		else if (m_rcAddTab.PtInRect(point) != 0)
			m_hHoverArea = m_hButAddTab;
		// 
	if(m_hHoverArea==NULL)
...
{	CWnd::OnLButtonUp(nFlags, point);
	...
	{	bool close = (m_hPushedArea==m_hButClose && m_rcCloseButton.PtInRect(point)!=0);
		...
		bool addTab = (m_hPushedArea == m_hButAddTab && m_rcAddTab.PtInRect(point) != 0);
			// 
		StopScrolling();
		Invalidate(FALSE);
		StopDragging(false);
		...
		{	bool alive = true;
			...
			{	CPoint pt(point);
				...
				// 
				m_pLifeStatus = &alive;
				m_hPushedArea = m_hButAddTab;
				m_pNotifyManager->OnAddTabButtonClicked(this, &m_rcAddTab, pt);
				// 
				if (alive == true)
				{
					m_hPushedArea = NULL;
...
{	return hTab==m_hButClose || hTab==m_hButMenu || hTab==m_hButLeftScroll || hTab==m_hButRightScroll || hTab==m_hButAddTab;
}
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
// 
...
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_base::DrawTab(TabCtrl *pCtrl, CDC *pDC, HTAB hTab, CRgn *pRgn, bool isCurrentTab)
{	CRect rc;
	pCtrl->GetTabRect(hTab,&rc);
		// 
		// draw background.
...
void TabCtrlStyle_base::DrawButtonAddTab(TabCtrl *pCtrl, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed, bool bPartialView)
{
	DrawButtonFrame(pCtrl, pDC, pRect, bHover, bPushed);
	// 
	CImageList *pImageList = pCtrl->GetSystemImageList();
	Draw::DrawMarker(pDC, pRect, pImageList, TabCtrl::IMAGE_ADD_TAB,
		GetButtonMarkerColor(pCtrl, bHover, bPushed));
}
/////////////////////////////////////////////////////////////////////////////
// 
...
{	return (pCtrl->GetLayout()==TAB_LAYOUT_TOP ? 
		CRect(5,1/*border*/+1,5,2) : CRect(5,2,5,0/*border*/));
}
/////////////////////////////////////////////////////////////////////////////
// 
...
CRect TabCtrlRecalcStub::GetAddTabButtonHorzMargin(TabCtrl *pCtrl, ITabCtrlRecalc *base)
{	return base->GetAddTabButtonHorzMargin(pCtrl, NULL);
}
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
